...
#       \_/ \/              \/                    \/
#
# last mod 18 mai 2022 change to 3.0
#
...
class ObjectGear(bpy.types.Operator):
    ...
    UseMod : bpy.props.BoolProperty(attr='UseMod',name="Use module", default=True)
    Pinions : bpy.props.BoolProperty(attr='Pinions',name="Pinion", default=False)
    Adv : bpy.props.BoolProperty(attr='Adv',name="Advenced setting", default=False)
    CloseObjs : bpy.props.BoolProperty(attr='CloseObjs',name="Close Mesh", default=False)
    TeethNs : bpy.props.IntProperty(attr='TeethNs',name="Teeth Number", default=40, min=9, soft_max=200)
    PitchRadiuss : bpy.props.FloatProperty(attr='PitchRadiuss',name="Reference Radius", min=0.5, soft_max=200,  default=20,unit='LENGTH',
                                           description="Pitch Radius")
    PressureAngs : bpy.props.IntProperty(attr='PressureAngs',name="Pressure angle",  default=20, min=10, max=40)
    HelicalAngs : bpy.props.IntProperty(attr='HelicalAngs',name="Tooth angle", default=0, min=-45, max=45,
                                        description="Angle of the tooth in an Helical (Spiral) gear tooth")
    Addendums : bpy.props.FloatProperty(attr='Addendums',name="Addendum ", min=0.001, soft_max=30, default=1, precision=1, unit='LENGTH',
                                        description="Addendum")
    Dedendums : bpy.props.FloatProperty(attr='Dedendums',name="Dedendum", min=0.001, soft_max=30, default=1, precision=1, unit='LENGTH',
                                        description="Dedendum")
    Fillets : bpy.props.FloatProperty(attr='Fillets',name="Fillet", min=0.0001, soft_max=1, default=0.05, precision=2, unit='LENGTH',
                                      description="Fillet")
    Resolutions : bpy.props.IntProperty(attr='Resolutions',name="Resolution", default=3, min=1, max=7,
                                        description="Resolution of the tooth profile")
    LongRess : bpy.props.IntProperty(attr='LongRess',name="Long. Res.", default=5, min=1, max=25,
                                     description="Resolution along the tooth extrusion")
    Thicknesss : bpy.props.FloatProperty(attr='Thicknesss',name="Thickness", default=5,  min=0.05,  soft_max=200, unit='LENGTH',
                                         description="Thickness of the tooth extrusion")
    Widths : bpy.props.FloatProperty(attr='Widths',name="Axis", min=0.01, soft_max=200, default=6, unit='LENGTH', precision=1,
                                     description="Concentrical inner extrusion from Inner tooth")
    props : bpy.props.EnumProperty(attr='props',name="Type", items=[("nor", "Normal", "Spur gear"), ("con", "Connical",
                                   "Connical gear"), ("cro", "Crown", "Crown"), ("rac", "Rack", "Rack")], default="nor")
    Alphas : bpy.props.IntProperty(attr='Alphas',name="Cone Angle", default=90, min=10, max=180,
                                   description="Full Angle at vertex cone")
    Ns : bpy.props.FloatProperty(attr='Ns',name="Multiply Rate", default=2, min=0.01, soft_max=30, description="Multipling rate")
    jeus : bpy.props.FloatProperty(attr='jeus',name="Backlash", default=1, min=0.6, max=1, precision=3, description="Backlash")
